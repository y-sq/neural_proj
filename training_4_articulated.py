...
RESULT_ROOT = "results/"
DATASET_ROOT = "data/articulated/"
def DATASET_DATA(i): return DATASET_ROOT + 'data_distance_constraint_square_rope_6_' + str(i) + '_ori.txt'
def DATASET_LABEL(i): return DATASET_ROOT + 'data_distance_constraint_square_rope_6_' + str(i) + '.txt'
DATASET_TS = 32
DATASET_SAMPLE_NUM = 6000
