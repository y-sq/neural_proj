...
RESULT_ROOT = "results/"
DATASET_ROOT = "data/rigid_16/"
def DATASET_DATA(i): return DATASET_ROOT + 'data_distance_constraint_rigid_16_4_' + str(i) + '_ori.txt'
def DATASET_LABEL(i): return DATASET_ROOT + 'data_distance_constraint_rigid_16_4_' + str(i) + '.txt'
DATASET_TS = 20
...
def training_main():
    ...
    train_ds, val_ds = get_data_loader(start=0, end=DATASET_SAMPLE_NUM, data_path=DATASET_DATA, label_path=DATASET_LABEL, 
                                       TS=DATASET_TS, P_N=NUM_PARTICLES, DIM=DIMENSION, split=0.8, error_thre=1)
